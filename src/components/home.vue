      ...
      <div class="auto-container">
        ...
        <div class="row clearfix">
          ...
          <div class="news-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
              <div class="image">
                <a href="blog-detail.html"><img src="@/assets/img/resource/news-1.jpg" alt="" /></a>
              </div>
                  ...
                  <div class="pull-left">
                    ...
                    <div class="author-box">
                      <div class="author-inner">
                        <div class="image">
                          <img src="@/assets/img/resource/author-1.jpg" alt="" />
                        </div>
          ...
          <div class="news-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
              <div class="image">
                <a href="blog-detail.html"><img src="@/assets/img/resource/news-2.jpg" alt="" /></a>
              </div>
              <div class="lower-content">
                <div class="time">On 15 August 2018 , 10 min Read</div>
                ...
                <div class="clearfix">
                  <div class="pull-left">
                    ...
                    <div class="author-box">
                      <div class="author-inner">
                        <div class="image">
                          <img src="@/assets/img/resource/author-2.jpg" alt="" />
                        </div>
                        <div class="admin">Admin ;</div>
          ...
          <div class="news-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
              <div class="image">
                <a href="blog-detail.html"><img src="@/assets/img/resource/news-3.jpg" alt="" /></a>
              </div>
              <div class="lower-content">
                <div class="time">On 15 August 2018 , 10 min Read</div>
                ...
                <div class="clearfix">
                  <div class="pull-left">
                    ...
                    <div class="author-box">
                      <div class="author-inner">
                        <div class="image">
                          <img src="@/assets/img/resource/author-3.jpg" alt="" />
                        </div>
                        <div class="admin">Admin ;</div>
