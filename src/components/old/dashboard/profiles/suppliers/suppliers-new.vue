        ...
        <div class="ph2" v-if="tabProps.supplierShow">
            <p class="w-100 cf  gray tracked"> PERSONAL Information</p>
              ...
              <div class="fl w-30-l pa1">
                <input type="file" class="dn" @change="uploadImageDisplay('Image')" ref="supplierImage"/>
                <img :src="record.Image" @error="record.Image = supplierIcon" class="w5 br-100 bg-near-white pa1" @click="uploadImage('supplierImage')" />
              </div>

              <div class="fl w-70-l">
                <div class="fl mv2 w-100 pa1">
                  <label class="db fw4 lh-copy f6 black"> Company Name:</label>
                  <input class="pa2 ba b--silver br2 bg-white w-100 " type="text" v-model="record.Fullname">
                </div>
...
<script type="text/javascript">
  ...
  import supplierIcon from "@/assets/img/user.png"
