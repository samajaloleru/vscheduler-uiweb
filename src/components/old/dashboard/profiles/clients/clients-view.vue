<template>
    <section>
      <div class="w-100 pa2 bg-light-gray br4 cf inline-flex items-center relative">
        ...
        <router-link :to="{name:'clients-search'}" class="fl right-1 absolute ph2 pv1 br4 bg-dark-red grow-ns pointer f6 white tc no-underline">
          Go Back
        </router-link>
      </div>
      ...
      <div v-if="isFound" class="bg-light-gray br4 cf">
        ...
        <div class="bg-light-gray ph2 pb2 br4 br--bottom cf black">
            ...
            <div class="ph2" v-if="tabProps.personalShow">
             <p class="w-100 cf  gray tracked"> PERSONAL Information</p>
              ...
              <div class="fl w-30-l pa1">
                <img :src="record.Image" @error="record.Image = clientIcon" class="w5 br-100 bg-near-white pa1" />
              </div>
              ...
              <div class="fl w-70-l">
                ...
                <div class="fl pa1 w-100">
                  ...
                  <div class="w4 pa2 ba b--silver br2 bg-white ">{{record.Workflow}}&nbsp;</div>
                </div>
          ...
          <div class="w-100 mt3">
            <router-link :to="{name:'clients-edit',params:{id:record.ID}}" class="fr ph3 pv2 br4 bg-green grow-ns pointer f6 white tc no-underline" >
              Edit
            </router-link>
          </div>
        </div>
