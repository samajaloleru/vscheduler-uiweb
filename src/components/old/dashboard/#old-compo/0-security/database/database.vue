...
<script type="text/javascript">
    ...
    export default {
        data() {return{
            ...
            "Sales","Salelines", "Orders","Orderlines", "Invoices","Invoicelines",
            "Purchases","Purchaselines", "Receivings","Receivinglines",
            "Pricelists","Pricelistlines", "Quotations","Quotationlines",
