<template>
    <section>
      ...
      <div v-if="isFound" class="bg-light-gray br4 cf pa2">
			...
			<otherlines :refid="$route.params.id" />
            ...
            <div class="w-100 mt3">
				<router-link :to="{name:'others-edit',params:{id:record.ID}}" class="fr ph3 pv2 br4 bg-green grow-ns pointer f6 white tc no-underline" >
				Edit
				</router-link>
			</div>
...
import otherlines from "@/components/dashboard/inventory/others/others-view-lines"
