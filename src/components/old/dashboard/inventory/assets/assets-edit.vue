    ...
    <section>
      <div class="w-100 pa2 bg-light-gray br4 cf inline-flex items-center relative">
        <div class="fl bg-light-gray pa2 pb fw5 tracked ttu f7 black ">
          Inventory / Asset Inventory / Edit
        </div>
        <router-link :to="{name:'assets-view',params:{id:record.ID}}" class="fl right-1 absolute ph2 pv1 br4 bg-red hover-bg-dark-red grow-ns pointer f6 white tc no-underline">
          Go Back
        </router-link>
      </div>
      ...
      <div v-if="isFound" class="bg-light-gray br4 cf pa2">
			...
			<assetlines :refid="$route.params.id" ref="assetlines" />
...
import assetlines from "@/components/dashboard/inventory/assets/assets-edit-lines"
