			...
			<div class="pa2 bg-light-gray br4 cf">
				...
				<div class="w-100">
					...
					<div class="fl pa2 mt3 mt0-ns w-100 w-third-l">
						<label class="db fw4 lh-copy f6 black"> Asset Location</label>
...
<script type="text/javascript">
	...
	export default {
		...
		data() {return{
			url: "/api/stocks",
			record: {Code:"asset", Currency:"USD", Workflow:"draft", Docdate: new Date().toISOString().slice(0,10)},
			notifications:[],
			partnerList:[],
			ownerList:[],
			isSave:true,
			...
			save () {
				...
				.then((response) => {
					...
					if(response.data.Body !== null){
						app.record = {Code:"asset", Currency:"USD"}
						app.$router.push({name:"assets-edit",params:{id:parseInt(response.data.Body)}})
					}
				}).catch((e) => {
					console.log(e)
				})
