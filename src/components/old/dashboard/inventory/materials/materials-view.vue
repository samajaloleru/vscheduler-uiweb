    ...
    <section>
      <div class="w-100 pa2 bg-light-gray br4 cf inline-flex items-center relative">
        <div class="fl bg-light-gray pa2 pb fw5 tracked ttu f7 black ">
          Inventory / Material Inventory / View
        </div>
      ...
      <div v-if="isFound" class="bg-light-gray br4 cf pa2">
			...
			<materiallines :refid="$route.params.id" />
            ...
            <div class="w-100 mt3">
				<router-link :to="{name:'materials-edit',params:{id:record.ID}}" class="fr ph3 pv2 br4 bg-green grow-ns pointer f6 white tc no-underline" >
				Edit
				</router-link>
			</div>
...
import materiallines from "@/components/dashboard/inventory/materials/materials-view-lines"
