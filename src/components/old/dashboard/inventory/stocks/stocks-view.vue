<template>
    <section>
      ...
      <div v-if="isFound" class="bg-light-gray br4 cf pa2">
			...
			<stocklines :refid="$route.params.id" />
            ...
            <div class="w-100 mt3">
				<router-link :to="{name:'stocks-edit',params:{id:record.ID}}" class="fr ph3 pv2 br4 bg-green grow-ns pointer f6 white tc no-underline" >
				Edit
				</router-link>
			</div>
...
import stocklines from "@/components/dashboard/inventory/stocks/stocks-view-lines"
