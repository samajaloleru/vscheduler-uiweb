<template>
		<section>
			<div class="w-100 pa2 bg-light-gray br4 cf inline-flex items-center relative">
				...
				<router-link :to="{name:'domains-view',params:{id:record.ID}}" class="fl right-1 absolute ph2 pv1 br4 bg-red hover-bg-dark-red grow-ns pointer f6 white tc no-underline">
					Go Back
				</router-link>
			</div>
				...
				<div class="fl w-100">
                    ...
                    <div class="fl w-100">
                        ...
                        <div class="fl pa2">  
                            ...
                            <input class="h2 w2 pointer absolute z-2 o-0 db " type="checkbox" v-model="record.IsSSL">
                            <div class="pv1">
                        ...
                        <div class="fl pa2">  
                            ...
                            <input class="h2 w2 pointer absolute z-2 o-0 db " type="checkbox" v-model="record.IsWWW">
                            <div class="pv1">
                                <div class="relative z-1 db w2 h1 br4 bg-white">
                        ...
                        <div class="fl pa2">  
                            ...
                            <input class="h2 w2 pointer absolute z-2 o-0 db " type="checkbox" v-model="record.IsWildcard">
                            <div class="pv1">
                                <div class="relative z-1 db w2 h1 br4 bg-white">
                    ...
                    <div class="fl w-100">
                        ...
                        <div class="fl pa2 w-50 w-25-l">
                            ...
                            <input class="pa2 ba b--silver br2 bg-white w-100 " type="text" v-model="record.Domain">
                        </div>

                        <div class="fl pa2 w-50 w-25-l">
                            <label class="db fw4 lh-copy f6 black">Proxy </label>
                            <input class="pa2 ba b--silver br2 bg-white w-100 " type="text" v-model="record.Proxy">
                        </div>
                    </div>
			...
			save () {
				...
				.then((response) => {
					...
					if(response.data.Body !== null){
						setTimeout(function(){
							app.$router.push({name:"domains-view",params:{id:response.data.Body}})
						},1000)
					} else {
						app.isSave = true;
					}
