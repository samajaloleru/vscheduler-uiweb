    ...
    <section>
      ...
      <div v-if="isFound" class="bg-light-gray br4 cf">
        ...
        <div class="bg-light-gray ph2 pb2 br4 br--bottom cf black">
            ...
            <div class="ph2" v-if="tabProps.personalShow">
             <p class="w-100 cf  gray tracked"> PERSONAL Information</p>
              ...
              <div class="fl w-30-l pa1">
                <img :src="record.Image" @error="record.Image = messageIcon" class="w5 br-100 bg-near-white pa1" />
              </div>
          ...
          <div class="w-100 mt3">
            <router-link :to="{name:'messages-edit',params:{id:record.ID}}" class="fr ph3 pv2 br4 bg-green grow-ns pointer f6 white tc no-underline" >
              Edit
            </router-link>
          </div>
        </div>
