<template>
		<section>
			<div class="w-100 pa2 bg-light-gray br4 cf inline-flex items-center relative">
				...
				<router-link :to="{name:'campaigns-view',params:{id:record.ID}}" class="fl right-1 absolute ph2 pv1 br4 bg-red hover-bg-dark-red grow-ns pointer f6 white tc no-underline">
					Go Back
				</router-link>
			</div>
				...
				<div class="fl w-100">
                    ...
                    <div class="fl w-100">
                        ...
                        <div class="fl pa2">  
                            ...
                            <input class="h2 w2 pointer absolute z-2 o-0 db "  type="checkbox" v-model.number="record.IsAuthenticated">
                            <div class="pv1">
                                <div class="relative z-1 db w2 h1 br4 bg-white">
                                    <div class="absolute w1 h1 br4 shadow-4 toggle-checkbox bg-animate" :class="{'bg-dark-green right-0':record.IsAuthenticated==1,'bg-dark-red left-0':record.IsAuthenticated==0}"></div>
                                </div>
                            </div>
                        </div>
			...
			save () {
				...
				.then((response) => {
					...
					if(response.data.Body !== null){
						setTimeout(function(){
							app.$router.push({name:"campaigns-view",params:{id:response.data.Body}})
						},1000)
					} else {
						app.isSave = true;
					}
