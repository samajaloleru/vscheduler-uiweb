            ...
            <article class="vh-100 dt w-100" style="background: linear-gradient(to top, rgba(255,255,255,0.15) 0%, rgba(0,0,0,0.15) 100%), radial-gradient(at bottom center, rgba(255,255,255,0.40) 0%, rgba(0,0,0,0.40) 120%) #989898; background-blend-mode: multiply,multiply;">
                <div class="dtc v-mid tc white ph3 ph4-l">
                        ...
                        <div class="cf bg-transparent ba b--white-10 br3 center pa3 " style="max-width:350px" >
                            ...
                            <div class="w-100 fl">
                            <p class="cf db w-100 f5 pt2 pb2 near-white fw4">Sign in to your Account</p>
                            </div>
                            ...
                            <div class="cf w-100 pv3">
                                <input class="signin f6 fw3 bn pa2 dib w-100 br2 bg-light-gray ba b--white" type="text" placeholder="Username" @keyup="keyUp" v-model="username" />
                            </div>

                            <div class="cf w-100 pv3">
                                <input class="signin f6 fw3 bn pa2 dib w-100 br2 bg-light-gray ba b--white" type="password" placeholder="Password" @keyup="keyUp" v-model="password" />
                            </div>

                            <span class="cf tl no-underline inline-flex items-center pa2 white bg-mid-gray ba b--white-40 br2 relative pointer"  @click="login()">
                                SIGN IN
                            ...
                            <div class="cf w-100 pv3">
                                <router-link to="/forgot" class="cf no-underline">
                                    <p class="fr near-white f7">Forgot Password?</p>
                                </router-link>
                            </div>
                            
                            <div class="cf w-100 pt4 near-white">
